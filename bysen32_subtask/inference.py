...
parser.add_argument('--data-dir', metavar='DIR', default='/media/ubuntu/Date12/TableStruct/new_data/debug',
...
parser.add_argument('--checkpoint', default='./output/train/model_best.pth.tar', type=str, metavar='PATH',
...
parser.add_argument('--results-dir', type=str, default='/media/ubuntu/Date12/TableStruct/new_data',
                    help='folder for output results')
parser.add_argument('--results-file', type=str, default='test_A_jpg480max_wireornot.json',
