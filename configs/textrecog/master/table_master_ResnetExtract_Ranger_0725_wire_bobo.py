...
alphabet_file = './tools/data/alphabet/structure_alphabet_bobo.txt'
...
train_pipeline = [
    ...
    dict(type='RandomLineMask', ratio=(0.0, 0.1), p=1.0),
    dict(
        type='TableAspect',
        ratio=(0.8, 1.25),
        p=0.2,
...
train_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster_wire/10fold0/cell_box_label/StructureLabelAddEmptyBbox_train/'
train1 = dict(
    type=dataset_type,
...
valid_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster_wire/10fold0/cell_box_label/StructureLabelAddEmptyBbox_valid/'
valid = dict(
    type=dataset_type,
...
test_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster_wire/10fold0/cell_box_label/StructureLabelAddEmptyBbox_valid/'
test = dict(
    type=dataset_type,
