...
train_pipeline = [
    ...
    # dict(type='BlackTest'),
    # dict(type='RandomLineMask', p=0.5),
    dict(type='RandomRCMask', ratio=0.2, p=0.5),
    # dict(type='RandomLineFill', p=1.0),
    dict(type="Albu", transforms=albu_train_transforms,),
    dict(type='TableAspect', p=1.0),
    # dict(type='TableRotate', p=1.0),
    dict(
        type='TableResize',
        keep_ratio=True,
        long_size=480),
    ...
    # dict(type='LabelVisible', dir_name='TablePad'),
...
valid_pipeline = [
    ...
    dict(type='TablePad', size=(480, 480), pad_val=0, return_mask=True, mask_ratio=(8, 8), train_state=TRAIN_STATE),
    # dict(type='LabelVisible', dir_name='valid_pipeline'),
    dict(type='TableBboxEncode'),
    dict(type='ToTensorOCR'),
    dict(type='NormalizeOCR', **img_norm_cfg),
    dict(
...
train_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster/10fold1/cell_box_label/StructureLabelAddEmptyBbox_train/'
train1 = dict(
    type=dataset_type,
...
valid_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster/10fold1/cell_box_label/StructureLabelAddEmptyBbox_valid/'
valid = dict(
    type=dataset_type,
...
test_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster/10fold1/cell_box_label/StructureLabelAddEmptyBbox_valid/'
test = dict(
    type=dataset_type,
...
# evaluation
evaluation = dict(interval=2, start=22, metric='acc')
