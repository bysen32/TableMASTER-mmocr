...
train_pipeline = [
    ...
    # dict(type='RandomLineFill', ratio=0.1, p=0.6),
    dict(
        type='TableAspect',
        ratio=(0.8, 1.25),
        p=0.2,
...
train_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster_wireless/10fold1/cell_box_label/StructureLabelAddEmptyBbox_train/'
train1 = dict(
    type=dataset_type,
...
valid_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster_wireless/10fold1/cell_box_label/StructureLabelAddEmptyBbox_valid/'
valid = dict(
    type=dataset_type,
...
test_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster_wireless/10fold1/cell_box_label/StructureLabelAddEmptyBbox_valid/'
test = dict(
    type=dataset_type,
