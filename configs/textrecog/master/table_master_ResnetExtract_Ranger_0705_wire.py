...
train_img_prefix = '/media/ubuntu/Date12/TableStruct/new_data/train_jpg480max_wire/'
train_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster_wire/10fold2/cell_box_label/StructureLabelAddEmptyBbox_train/'
train1 = dict(
    type=dataset_type,
...
valid_img_prefix = '/media/ubuntu/Date12/TableStruct/new_data/train_jpg480max_wire/'
valid_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster_wire/10fold2/cell_box_label/StructureLabelAddEmptyBbox_valid/'
valid = dict(
    type=dataset_type,
...
test_img_prefix = '/media/ubuntu/Date12/TableStruct/new_data/train_jpg480max_wire/'
test_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster_wire/10fold2/cell_box_label/StructureLabelAddEmptyBbox_valid/'
test = dict(
    type=dataset_type,
...
load_from = './checkpoints/wire_10fold2_best.pth'
resume_from = None
