...
train_img_prefix = '/media/ubuntu/Date12/TableStruct/new_data/train_jpg480max_wireless/'
train_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster_wireless/10fold2/cell_box_label/StructureLabelAddEmptyBbox_train/'
train1 = dict(
    type=dataset_type,
...
valid_img_prefix = '/media/ubuntu/Date12/TableStruct/new_data/train_jpg480max_wireless/'
valid_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster_wireless/10fold2/cell_box_label/StructureLabelAddEmptyBbox_valid/'
valid = dict(
    type=dataset_type,
...
test_img_prefix = '/media/ubuntu/Date12/TableStruct/new_data/train_jpg480max_wireless/'
test_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster_wireless/10fold2/cell_box_label/StructureLabelAddEmptyBbox_valid/'
test = dict(
    type=dataset_type,
