...
train_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster_wire/10fold6/cell_box_label/StructureLabelAddEmptyBbox_train/'
train1 = dict(
    type=dataset_type,
...
valid_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster_wire/10fold6/cell_box_label/StructureLabelAddEmptyBbox_valid/'
valid = dict(
    type=dataset_type,
...
test_anno_file1 = '/media/ubuntu/Date12/TableStruct/new_data/tablemaster_wire/10fold6/cell_box_label/StructureLabelAddEmptyBbox_valid/'
test = dict(
    type=dataset_type,
