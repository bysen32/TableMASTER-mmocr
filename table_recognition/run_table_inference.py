...
if __name__ == "__main__":
    ...
    subprocess.call("CUDA_VISIBLE_DEVICES=0 python -u ./table_recognition/table_inference.py 2 0 2 &"
                    "CUDA_VISIBLE_DEVICES=1 python -u ./table_recognition/table_inference.py 2 1 2 &", shell=True)
    time.sleep(60)
